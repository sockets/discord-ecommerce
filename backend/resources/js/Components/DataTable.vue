            ...
            <table class="min-w-max w-full table-auto">
                ...
                <tbody class="text-gray-200 text-sm font-light">
                    <tr class="border-b border-gray-700 hover:bg-slate-800">
                        ...
                        <td class="py-3 px-6 text-left">
                            <div class="flex items-center">
                                <span>AKJSJF-ASFASFAS-ASFGHJWAWQE</span>
                            </div>
                        </td>
                        <td class="py-3 px-6 text-left">
                            <div class="flex items-center">
                                <span>Jan 17th, 2022 14:30 EST</span>
                            </div>
                        </td>
                        <td class="py-3 px-6 text-left">
                            <div class="flex items-center">
                        ...
                        <td class="py-3 px-6 text-left">
                            <div class="flex items-center">
                                <span>Jan 12th, 2022 17:30 EST</span>
                            </div>
                        </td>
                    ...
                    </tr><tr class="border-b border-gray-700 hover:bg-slate-800">
                        <td class="py-3 px-6 text-left">
                            <div class="flex items-center">
                                <div class="mr-2">
